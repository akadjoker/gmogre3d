...
#ifndef GMOGRE_CCS_CHASE_FREE_YAW_AXIS_CAMERA_MODE_H
#define GMOGRE_CCS_CHASE_FREE_YAW_AXIS_CAMERA_MODE_H
...
{
   CCS::ChaseFreeYawAxisCameraMode *cam_mode = ConvertFromGMPointer<CCS::ChaseFreeYawAxisCameraMode*>(camera_mode_ptr);
...
/*
GMFN double SetChaseFreeYawAxisCameraModeCollisionCallback(double camera_mode_ptr, double func)
{
   CCS::ChaseFreeYawAxisCameraMode *cam_mode = ConvertFromGMPointer<CCS::ChaseFreeYawAxisCameraMode*>(camera_mode_ptr);
