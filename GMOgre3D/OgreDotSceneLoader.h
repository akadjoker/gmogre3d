...
#include "rapidxml.hpp"
    ...
    public:
        ...
        std::map<Ogre::String, Ogre::Node *> nodeObjects;
        std::map<Ogre::String, Ogre::MovableObject *> cameraObjects;
        std::map<Ogre::String, Ogre::MovableObject *> entityObjects;
        std::map<Ogre::String, Ogre::MovableObject *> billboardSetObjects;
        std::map<Ogre::String, Ogre::MovableObject *> lightObjects;
        std::map<Ogre::String, Ogre::MovableObject *> particleSystemObjects;
