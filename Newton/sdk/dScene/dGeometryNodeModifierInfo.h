...
{
	public:
	NE_DEFINE_CLASS_NODE(dGeometryNodeModifierInfo,dNodeInfo)
...
//	virtual dFloat RayCast (const dVector& p0, const dVector& p1) const {return 1.0f;}
	...
	virtual TiXmlElement* Serialize (TiXmlElement* parentNode) { return NULL; }
	virtual bool Deserialize (TiXmlElement* node, int revisionNumber) { return true;}
